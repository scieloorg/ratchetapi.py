...
from ratchetapi import exceptions, httpbroker
from . import doubles
...
class ConnectorHttpBrokerCollaborationTests(mocker.MockerTestCase):
    ...
    def _makeOne(self, *args, **kwargs):
        from ratchetapi.core import Connector
    ...
    def test_api_uri_defaults_to_manager_scielo_org(self):
        ...
        self.assertTrue(conn.api_uri.startswith('http://ratchet.scielo.org'))
    ...
    def test_iter_docs_offset_moves_forward(self):
        from ratchetapi.core import ITEMS_PER_REQUEST as ITEMS
...
class EndpointTests(mocker.MockerTestCase):
    ...
    def _makeOne(self, *args, **kwargs):
        from ratchetapi.core import Endpoint
...
class ClientTests(mocker.MockerTestCase):
    ...
    def _makeOne(self, *args, **kwargs):
        from ratchetapi.core import Client
    ...
    def test_known_version_can_be_used(self):
        from ratchetapi.core import API_VERSIONS
        API_VERSIONS += ('v2',)
